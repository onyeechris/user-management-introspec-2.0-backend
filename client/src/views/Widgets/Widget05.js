...
class Widget05 extends Component {
  render() {
    const { className, cssModule, header, icon1, icon2, icon3, metric1, metric2, metric3, color, value, children, invert, ...attributes } = this.props;
    ...
    return (
      <Card className={classes} {...attributes}>
        <CardBody>
          <div className="h6 text-muted text-right mb-4">
            {metric1} {" "}
            <i className={icon1}></i>&nbsp;&nbsp;&nbsp;
            {metric2}{" "}
            <i className={icon2}></i>&nbsp;&nbsp;&nbsp;
