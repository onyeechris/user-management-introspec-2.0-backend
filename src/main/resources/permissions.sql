...
insert into permissions (id, action, description, module_name) values(1, 'CREATE-ACCOUNT', 'creating account endpoint', 'ATM');
insert into permissions (id, action, description, module_name) values(2, 'POST-ACCOUNT', 'endpoint for posting to core banking', 'USER');
