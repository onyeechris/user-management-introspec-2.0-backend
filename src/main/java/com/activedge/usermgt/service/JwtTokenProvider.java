...
//                         System.out.println("jdbc: >>" + staffPermissions);
                        ...
                        authority.setId(AuthoritiesConstants.ROLE_PRE_VERIFICATION_USER);
...
//        Date expiryDate = new Date(now.getTime() + jwtExpirationInMs);
        Date expiryDate = new Date(now.getTime() + (authenticated ? jwtExpirationInMs : TEMP_TOKEN_VALIDITY_IN_MILLIS));
